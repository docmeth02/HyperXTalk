const char * MCexecutionerrors = 
	...
	"flip: object is not an editable image\n"
	...
	"avgDev: error in source expression\n"
	"geometricMean: error in source expression\n"
	"harmonicMean: error in source expression\n"
	"pStdDev: error in source expression\n"
	"pVariance: error in source expression\n"
	"variance: error in source expression\n"
	"group: object cannot be grouped\n"
	"measureText: no object\n"
	"font: couldn't find font\n"
	"edit script: bad at expression\n"
	"fullscreenmode: not a valid mode\n"
	"pixelScale: not a valid scale value\n"
	"scaleFactor: not a valid scale value\n"
	"pixelScale: the pixelScale property cannot be set on this platform\n"
	"usePixelScaling: the usePixelScaling property cannot be set on this platform\n"
	"secure: error in socket expression\n"
	"paramCount: could not find handler\n"
	"send: too many pending messages\n"
	"secure: error in host name expression\n"
	"open: error in host name expression\n"
	"Chunk: bad extents provided\n"
	"external: unlicensed\n"
	"Import: no image selected, or image not open\n"
	"Resolve image: error in source expression\n"
	"Internal BSDiff: error in old file expression\n"
	"Internal BSDiff: error in new file expression\n"
	"Internal BSDiff: error in patch filename expression\n"
	"Internal Bootstrap: error in stack file\n"
	"IDE script configure: error in settings expression\n"
	"IDE script replace: error in text expression\n"
	"IDE script classify: error in script expression\n"
	"IDE filter control: error in pattern expression\n"
	"Engine PutInto: error in variable expression\n"
	"Engine DeleteVariableChunk: error in expression\n"
	"IDE Extract: error in segment expression\n"
	"IDE Extract: error in section name expression\n"
	"IDE Extract: error in filename expression\n"
	"MCInternalPayloadPatch: error in output filename expression\n"
	"MCInternalListTasksWithModule: error in module expression\n"
	"MCInternalCanDeleteFile: error in filename expression\n"
	"MCInternalCanDeleteKey: error in key expression\n"
	"MCHandler: error in expression\n"
	"textDecode: bad data expression\n"
	"textDecode: bad text encoding expression\n"
	"textDecode: could not decode data\n"
	"textEncode: bad text expression\n"
	"textEncode: bad text encoding expression\n"
	"textEncode: could not encode text\n"
	"normalizeText: bad normal form\n"
	"normalizeText: bad text expression\n"
	"codepointProperty: bad codepoint\n"
	"codepointProperty: bad property name\n"
	"open: bad text encoding\n"
	"open: unsupported encoding\n"
	"bidiDirection: error in source expression\n"
	"start: script of specified stack won't compile\n"
	"hostnameToAddress: callbacks are not allowed on server\n"
	"Error evaluating expression\n"
	"Property: value is not a character\n"
	"Property: value is not a string\n"
	"Property: value is not a color\n"
	"Property: value is not a rectangle\n"
	"Property: value is not a point\n"
	"Property: value is not a pair of integers\n"
	"Property: value is not a quadruple of integers\n"
	"Property: invalid enumeration value\n"
	"Backdrop: invalid value\n"
	"Property: value is not an array\n"
	"MCInternalPayloadPatch: error in patch item expression\n"
	"MCInternalPayloadPatch: error in base item expression\n"
	"floor: bad parameter\n"
	"ceil: bad parameter\n"
	"commandArguments: bad parameter\n"
	"extension: error occurred with domain\n"
	"extension: error occurred with description\n"
	"extension: error occurred with file\n"
	"extension: error occurred with line\n"
	"load: error in extension expression\n"
	"load: error in resource path expression\n"
	"System error: function\n"
	"System error: code\n"
	"System error: message\n"
	"Import: bad array\n"
	"Import: not an object array\n"
	"clipboard: bad item type or data\n"
	"clipboard: failed to insert item\n"
	"clipboard: clipboard not locked\n"
	"clipboard: already locked\n"
	"clipboard: needs to be cleared (contains external data)\n"
	"go: error in widget expression\n"
	"launch: error in widget expression\n"
	"do: error in widget expression\n"
	"documentFilename: bad filename\n"
	"save: error in file format expression\n"
	"replace: not a field chunk\n"
	"call: too few arguments\n"
	"call: too many arguments\n"
	"Stack: script only stacks can not be password protected\n"
	"revert: can't find stack\n"
	"vectordot: error in first parameter\n"
	"vectordot: error in second parameter\n"
	"vectordot: arrays are not key-wise compatible\n"
	"files: error in folder parameter\n"
	"folders: error in folder parameter\n"
	"no target object\n"
	"image: cannot change image while being edited\n"
	"graphic : too many points\n"
	"extension: error occurred with column\n"
	"parentScript: can't change parent while parent script is executing\n"
	"call: type conversion error\n"
	"open: error in from address expression\n"
	"messageDigest: error in digest type parameter\n"
	"messageDigest: error in message data parameter\n"
	"snapshot: no screen\n"
	"stack: password protecting stacks not supported in this edition\n"
	"files: error in kind parameter\n"
	"folders: error in kind parameter\n"
	"library mapping: bad mapping\n"
	"fontLanguage: bad font name\n"
	"android permission: bad permission name\n"
	"Property: value is not a data\n"
;
...
const char * MCparsingerrors = 
	...
	"avgDev: bad parameters\n"
	"geometricMean: bad parameters\n"
	"harmonicMean: bad parameters\n"
	"pStdDev: bad parameters\n"
	"pVariance: bad parameters\n"
	"variance: bad parameters\n"
	"measureText: no object\n"
	"measureText: bad text parameter\n"
	"measureText: bad mode parameter\n"
	"resolve image: bad image reference\n"
	"resolve image: bad object reference\n"
	"edit script: no at expression\n"
	"assert: bad type\n"
	"assert: bad expression\n"
	"secure: missing 'socket'\n"
	"secure: bad socket name\n"
	"secure: expected 'verification'\n"
	"textDecode: bad parameters\n"
	"textEncode: bad parameters\n"
	"normalizeText: bad parameters\n"
	"codepointProperty: bad parameters\n"
	"open: bad encoding parameter\n"
	"open: no encoding when opening in binary mode\n"
	"secure: bad host name\n"
	"secure: expected 'host'\n"
	"open: bad host name\n"
	"open: expected 'host'\n"
	"bidiDirection: bad parameters\n"
	"floor: error in source expression\n"
	"ceil: error in source expression\n"
	"global: shadowing a local variable\n"
	"load: error in extension expression\n"
	"load: expected 'resource'\n"
	"load: expected 'path'\n"
	"load: error in resource path expression\n"
	"load: missing file or display name\n"
	"load: missing 'from'\n"
	"is strictly: missing 'an' or 'a'\n"
	"is strictly: missing 'string'\n"
	"is strictly: missing type\n"
	"import: no array expression\n"
	"export: no array expression\n"
	"go: error in widget expression\n"
	"launch: error in widget expression\n"
	"save: error in format expression\n"
	"replace: missing 'styles'\n"
	"revert: bad stack expression\n"
	"vectordot: bad parameter\n"
	"return: form not allowed in handler type\n"
	"return: form not allowed in handler type\n"
	"files: bad folder expression\n"
	"folders: bad folder expression\n"
	"open: expected 'from' address\n"
	"messageDigest: bad parameters\n"
	"setop: missing 'difference'\n"
	"setop: 'recursive' only makes sense for union or intersect\n"
	"setop: destination is not a container (did you mean to use 'into'?)\n"
	"send: can't send script in time\n"
	"fontLanguage: bad type expression\n"
	"out of memory\n"
;
